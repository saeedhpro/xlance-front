...
<!--    </p>-->
    <div class="my-10 sm:text-left text-center text-white">
      <button type="button" class="w-64 h-10 p-1 ir-medium  rounded-lg bg-greentype btnSave"  @click="saveArticle">ثبت مقاله</button>
    </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            saveArticle(){
                this.$store.dispatch('articlesAdmin/getAddArticle', {
                    title:this.title,
                    body:this.body,
                    ...
                    .then(res=>{
                        ...
                        this.$swal('مقاله شما با موفقیت ثبت شد', {
                            icon: 'success'
                        });
                    })
                    .catch(async err=>{
