...
<!--        </div>-->
    ...
    <div class="flex-col">
      <div class="flex px-1 py-1 border-dashed border-2 border-purple-600 rounded-lg text-center float-left" style="align-items: center;">
        <span v-text="number" class="ml-2 ir-bold text-purple-600" style="font-size: 23px">۴۵۶۷</span>
        <span class="ir-light text-gray-600 text-purple-600 text-sm"><slot name="name-inf">پروژه</slot></span>
      </div>
      <div class="mt-12"
           style="    display: flex;
    flex-wrap: wrap;
