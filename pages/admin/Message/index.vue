        ...
        <div class="w-full h-auto px-4 py-4 bg-gray-300">
          <div v-if="conversation" class="flex justify-space-between align-center">
            <div class="flex flex-wrap justify-start items-center">
              ...
              <div class="w-64 mx-auto  bg-gray-100 rounded-lg text-center align-center">
                <span class="py-auto ir-medium">{{`${conversation.project ? conversation.project.title: ''}`}}</span>
              </div>
            </div>
            <div @click="showMessageList" class="text-gray-600">
